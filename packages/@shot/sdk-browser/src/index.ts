...
import type { EventPayload } from '@shot/sdk-core';

const SDK_NAME = '@shot/sdk-browser';
const SDK_VERSION = '0.0.1';
const ANON_ID_KEY = 'shot_anonymous_id';
const SESSION_ID_KEY = 'shot_session_id';
...
export const shot = new ShotBrowser();
