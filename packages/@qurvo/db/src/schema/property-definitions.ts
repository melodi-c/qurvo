...
export const propertyDefinitions = pgTable('property_definitions', {
  ...
  event_name: varchar('event_name', { length: 500 }).notNull().default(''),
  ...
  uniqueIndex('property_definitions_project_event_name_type_idx').on(table.project_id, table.event_name, table.property_name, table.property_type),
