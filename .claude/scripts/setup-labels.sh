...
labels=(
  ...
  "ingest|Event collection (apps/ingest)|0075CA"
  "processor|Event processor (apps/processor)|0075CA"
  "cohort-worker|Cohort worker (apps/cohort-worker)|0075CA"
  "billing-worker|Billing worker (apps/billing-worker)|0075CA"
